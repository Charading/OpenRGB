...
RGBColor CMRGBController::GetModeColor(int color_number)
{
    switch (color_number)
    {
        case 0: return current_mode_color_1;
        case 1: return current_mode_color_2;
        default: return ToRGBColor(0, 0, 0);
    }
}
...
RGBColor CMRGBController::GetPortColor(int port_number)
{
    switch (port_number)
    {
        case 0: return current_port1_color;
        case 1: return current_port2_color;
        case 2: return current_port3_color;
        case 3: return current_port4_color;
        default: return ToRGBColor(0, 0, 0);
    }
}
