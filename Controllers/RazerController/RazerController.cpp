...
void RazerController::razer_set_mode_none()
{
    ...
    switch(dev_pid)
    {
        ...
        case RAZER_CORE_PID:
        case RAZER_CHROMA_MUG_PID:
            report                      = razer_create_mode_none_standard_matrix_report(RAZER_STORAGE_NO_SAVE, RAZER_LED_ID_BACKLIGHT);
            report.transaction_id.id    = 0x3F;
            break;
        ...
        case RAZER_NAGA_HEX_V2_PID:
        case RAZER_NAGA_CHROMA_PID:
            report                      = razer_create_mode_none_extended_matrix_report(RAZER_STORAGE_NO_SAVE, RAZER_LED_ID_BACKLIGHT);
            break;
        ...
        case RAZER_NOMMO_PRO_PID:
        case RAZER_NOMMO_CHROMA_PID:
            report                      = razer_create_mode_none_extended_matrix_report(RAZER_STORAGE_NO_SAVE, RAZER_LED_ID_ZERO);
            report.transaction_id.id    = 0x3F;
            break;
