...
REGISTER_HID_DETECTOR_IPU("EVGA Z15 Keyboard",     DEVICE_TYPE_KEYBOARD, DetectEVGAKeyboardControllers,   EVGA_USB_VID,   Z15_ISO_PID,                1,  0x08,   0x4B);
REGISTER_HID_DETECTOR_IPU("EVGA Z15 Keyboard",     DEVICE_TYPE_KEYBOARD, DetectEVGAKeyboardControllers,   EVGA_USB_VID,   Z15_ANSI_PID,               1,  0x08,   0x4B);
REGISTER_HID_DETECTOR_IPU("EVGA Z20 Keyboard",     DEVICE_TYPE_KEYBOARD, DetectEVGAKeyboardControllers,   EVGA_USB_VID,   Z20_ANSI_PID,               1,  0x08,   0x4B);
REGISTER_HID_DETECTOR_IPU("EVGA Z20 Keyboard",     DEVICE_TYPE_KEYBOARD, DetectEVGAKeyboardControllers,   EVGA_USB_VID,   Z20_UK_PID,                 1,  0x08,   0x4B);

REGISTER_HID_DETECTOR_IPU("EVGA X20 Gaming Mouse",  DEVICE_TYPE_MOUSE, DetectWiredEVGAMouse,           EVGA_USB_VID,   X20_WIRED_PID,              2,  0xFFFF, 0);
REGISTER_HID_DETECTOR_IPU("EVGA X20 USB Receiver",  DEVICE_TYPE_MOUSE, DetectWirelessEVGAMouse,        EVGA_USB_VID,   X20_WIRELESS_ADAPTER_PID,   2,  0xFFFF, 0);
