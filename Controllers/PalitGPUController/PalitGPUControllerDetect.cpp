...
REGISTER_I2C_PCI_DETECTOR("Palit GTX 1060",    DEVICE_TYPE_GPU, DetectPalitGPUControllers, NVIDIA_VEN, NVIDIA_GTX1060_DEV, NVIDIA_SUB_VEN, NVIDIA_GTX1060_DEV,     0x08);
REGISTER_I2C_PCI_DETECTOR("Palit GTX 1070",    DEVICE_TYPE_GPU, DetectPalitGPUControllers, NVIDIA_VEN, NVIDIA_GTX1070_DEV, NVIDIA_SUB_VEN, NVIDIA_GTX1070_DEV,     0x08);
REGISTER_I2C_PCI_DETECTOR("Palit GTX 1070 Ti", DEVICE_TYPE_GPU, DetectPalitGPUControllers, NVIDIA_VEN, NVIDIA_GTX1070TI_DEV, NVIDIA_SUB_VEN, NVIDIA_GTX1070TI_DEV, 0x08);
REGISTER_I2C_PCI_DETECTOR("Palit GTX 1080",    DEVICE_TYPE_GPU, DetectPalitGPUControllers, NVIDIA_VEN, NVIDIA_GTX1080_DEV, NVIDIA_SUB_VEN, NVIDIA_GTX1080_DEV,     0x08);
REGISTER_I2C_PCI_DETECTOR("Palit GTX 1080 Ti", DEVICE_TYPE_GPU, DetectPalitGPUControllers, NVIDIA_VEN, NVIDIA_GTX1080TI_DEV, NVIDIA_SUB_VEN, NVIDIA_GTX1080TI_DEV, 0x08);
