...
REGISTER_HID_DETECTOR_IPU("Bloody W60 Pro",      DEVICE_TYPE_MOUSE,    DetectA4TechMouseControllers,       A4_TECH_VID,    BLOODY_W60_PRO_PID,     2,      0xFF33,     0x0529);
REGISTER_HID_DETECTOR_IPU("Bloody W70 Max",      DEVICE_TYPE_MOUSE,    DetectA4TechMouseControllers,       A4_TECH_VID,    BLOODY_W70_MAX_PID,     2,      0xFF33,     0x0518);
REGISTER_HID_DETECTOR_IPU("Bloody W90 Max",      DEVICE_TYPE_MOUSE,    DetectA4TechMouseControllers,       A4_TECH_VID,    BLOODY_W90_MAX_PID,     2,      0xFF33,     0x053D);
REGISTER_HID_DETECTOR_IPU("Bloody MP 50RS",      DEVICE_TYPE_MOUSE,    DetectA4TechMouseControllers,       A4_TECH_VID,    BLOODY_MP_50RS_PID,     2,      0xFFF2,     0x6009);
REGISTER_HID_DETECTOR_IPU("A4Tech Bloody B820R", DEVICE_TYPE_KEYBOARD, DetectBloodyB820R,                  A4_TECH_VID,    BLOODY_B820R_PID,       2,      0xFF52,     0x0210);
