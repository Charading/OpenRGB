...
void DetectAsusAuraSMBusRAMControllers(std::vector<i2c_smbus_interface*> &busses)
{
...
REGISTER_I2C_DETECTOR("ASUS Aura SMBus RAM", DetectAsusAuraSMBusRAMControllers);
