...
RGBController_AMDWraithPrism::RGBController_AMDWraithPrism(AMDWraithPrismController* wraith_ptr)
{
    ...
    Rainbow.brightness          = AMD_WRAITH_PRISM_FAN_BRIGHTNESS_CYCLE_MAX;    //The Ring zone can not get brighter but Logo / Fan can
    ...
    Bounce.brightness           = AMD_WRAITH_PRISM_FAN_BRIGHTNESS_CYCLE_MAX;    //The Ring zone can not get brighter but Logo / Fan can
