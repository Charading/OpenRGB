...
void SetColor(const std::vector<RGBColor>& colors, unsigned char* color_data)
{
...
RGBColor ToLogoColor(RGBColor rgb)
{
...
std::string NZXTKrakenController::GetFirmwareVersion() const
{
...
void NZXTKrakenController::UpdateStatus()
{
    ...
    liquid_temperatur = usb_buf[0x1] + (usb_buf[0x2] * 0.1);
