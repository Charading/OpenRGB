...
RGBController_AuraKeyboard::RGBController_AuraKeyboard(AuraKeyboardController* aura_ptr)
{
    ...
    Quicksand.flags      = MODE_FLAG_HAS_MODE_SPECIFIC_COLOR | MODE_FLAG_HAS_RANDOM_COLOR |MODE_FLAG_HAS_SPEED;
...
void RGBController_AuraKeyboard::DeviceUpdateMode()
{
    ...
    if (modes[active_mode].value == 15) {
        ...
        aura->UpdateDevice(modes[active_mode].value, mode_colors, modes[active_mode].direction, color_mode, (15 - modes[active_mode].speed));
    }
