...
JginYueGPIOController::JginYueGPIOController(hid_device* dev_handle, const char* path)
{
    DMIInfo         dmi;
...
void JginYueGPIOController::Init_device(AreaConfiguration* ptr_device_cfg)
{
...
void JginYueGPIOController::WriteZoneMode
    (
    unsigned char   zone,
    unsigned char   mode,
    RGBColor        rgb,
