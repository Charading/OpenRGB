...
void LogitechX56Controller::SetColors(std::vector<RGBColor> colors)
{
    ...
    cbuf[0x00]  = 0x09;
    cbuf[0x02]  = 0x03;
    cbuf[0x03]  = RGBGetRValue(colors[0]);
    cbuf[0x04]  = RGBGetGValue(colors[0]);
    cbuf[0x05]  = RGBGetBValue(colors[0]);
