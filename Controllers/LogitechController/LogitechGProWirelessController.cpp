...
std::string LogitechGProWirelessController::GetDescription()
{
    std::string temp = "Wireless device connected at device index ";
    temp += std::to_string(lightspeed->device_index);
    return temp;
}
