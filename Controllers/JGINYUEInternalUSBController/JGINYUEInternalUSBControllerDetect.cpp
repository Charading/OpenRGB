...
#ifdef _WIN32
REGISTER_HID_DETECTOR("JGINYUE Internal USB Controller", DEVICE_TYPE_MOTHERBOARD, DetectJGINYUEInternalUSBController, JGINYUE_VID, JGINYUE_MOTHERBOARD_PID);
#else
REGISTER_HID_DETECTOR_IPU("JGINYUE Internal USB Controller", DEVICE_TYPE_MOTHERBOARD, DetectJGINYUEInternalUSBController, JGINYUE_VID, JGINYUE_MOTHERBOARD_PID, 0, 0xFF00, 1);
#endif
