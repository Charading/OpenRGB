...
REGISTER_HID_DETECTOR("Sony DualShock 4", DEVICE_TYPE_GAMEPAD, DetectSonyDS4Controllers,       SONY_VID, SONY_DS4_V1_PID);
REGISTER_HID_DETECTOR("Sony DualShock 4", DEVICE_TYPE_GAMEPAD, DetectSonyDS4Controllers,       SONY_VID, SONY_DS4_V2_PID);
REGISTER_HID_DETECTOR("Sony DualShock 4", DEVICE_TYPE_GAMEPAD, DetectSonyDS4Controllers,       SONY_VID, SONY_DS4_RECEIVER_PID);
REGISTER_HID_DETECTOR("Sony DualSense",   DEVICE_TYPE_GAMEPAD, DetectSonyDualSenseControllers, SONY_VID, SONY_DUALSENSE_PID);
