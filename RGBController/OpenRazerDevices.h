...
/*-------------------------------------------------------------*\
|  Razer Deathstalker Expert 1532:0202 , false, {1,1}                      |
|                                                               |
|  Zone "Keyboard"                                              |
|       Single                                                  |
|       1                                      |
\*-------------------------------------------------------------*/
static const razer_zone deathstalker_expert_zone =
{
    "Keyboard",
    ZONE_TYPE_MATRIX,
    6,
...
static const razer_device deathstalker_expert_device =
{
